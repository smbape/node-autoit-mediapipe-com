...
;~ Sources:
;~     https://github.com/google-ai-edge/mediapipe/blob/v0.10.24/mediapipe/tasks/python/test/text/text_embedder_test.py
...
Func Test()
	...
	test_embed( _
			...
			0.974150, _
			512, _
			_Mediapipe_Tuple(21.2054, 22.257518) _
			)
	test_embed( _
			True, _
			False, _
			...
			0.974150, _
			512, _
			_Mediapipe_Tuple(0.0625787, 0.0708920) _
			)
	test_embed( _
			False, _
			False, _

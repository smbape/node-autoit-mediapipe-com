...
;~ Sources:
;~     https://github.com/google-ai-edge/mediapipe/blob/v0.10.22/mediapipe/python/solutions/face_mesh_test.py
...
Global Const $mp_faces = _Mediapipe_ObjCreate("mediapipe.autoit.solutions.face_mesh")
_AssertIsObj($mp_faces, "Failed to load mediapipe.autoit.solutions.face_mesh")

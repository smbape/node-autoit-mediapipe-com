const declarations = [
    ...
    ["get_image_frame", "mediapipe::ImageFrame", "std::shared_ptr<mediapipe::ImageFrame>", ["/WrapAs=::autoit::reference_internal"]],
    ["get_image", "mediapipe::Image", "", []],
].map(([fname, type_name, return_value_type, func_modifiers]) => {
    func_modifiers.push(...[
        `/Call=GetContent<${ type_name }>`,
    ]);
    return [`mediapipe.autoit.packet_getter.${ fname }`, return_value_type || type_name, func_modifiers, [

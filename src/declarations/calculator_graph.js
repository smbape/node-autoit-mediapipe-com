module.exports = ({ self_get }) => [
    ...
    ["mediapipe.CalculatorGraph.add_packet_to_input_stream", "void", ["/Call=mediapipe::autoit::calculator_graph::add_packet_to_input_stream", `/Expr=${ self_get() }, $0`], [
    ...
    ["mediapipe.CalculatorGraph.close", "void", ["/Call=mediapipe::autoit::calculator_graph::close", `/Expr=${ self_get() }`], [], "", ""],

    ["mediapipe.CalculatorGraph.observe_output_stream", "void", ["/Call=mediapipe::autoit::calculator_graph::observe_output_stream", `/Expr=${ self_get() }, $0`], [

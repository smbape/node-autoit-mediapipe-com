module.exports = ({self, language, cname}) => {
    const progid = `mediapipe.tasks.${ language }.vision.core.image_frame`;

    return [
        ["class mediapipe.ImageFrame", "", [`/progid=${ progid }.ImageFrame`], [
            ["int", "width", "", ["/R", "=Width()"]],
            ["int", "height", "", ["/R", "=Height()"]],
        ...
        // expose an image_frame properties like in mediapipe python
        [`${ progid }.`, "", ["/Properties"], [

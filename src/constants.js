...
exports.ALIASES = new Map([
    ...
    ["tasks_core_proto_BaseOptions", "tasks::core::proto::BaseOptions"],
    ["tasks_components_containers_proto_Classifications", "tasks::components::containers::proto::Classifications"],
    ["tasks_components_containers_proto_ClassificationResult", "tasks::components::containers::proto::ClassificationResult"],
    ["tasks_components_containers_proto_Embedding", "tasks::components::containers::proto::Embedding"],
    ["tasks_components_containers_proto_EmbeddingResult", "tasks::components::containers::proto::EmbeddingResult"],
    ["tasks_containers_proto_LandmarksDetectionResult", "tasks::containers::proto::LandmarksDetectionResult"],
    ["tasks_components_processors_proto_ClassifierOptions", "tasks::components::processors::proto::ClassifierOptions"],
    ["bounding_box_BoundingBox", "bounding_box::BoundingBox"],
    ["category_Category", "category::Category"],
    ["detections_Detection", "detections::Detection"],
    ["detections_DetectionResult", "detections::DetectionResult"],
    ["landmark_Landmark", "landmark::Landmark"],
    ["landmark_NormalizedLandmark", "landmark::NormalizedLandmark"],
    ["rect_Rect", "rect::Rect"],
    ["rect_NormalizedRect", "rect::NormalizedRect"],
    ["containers_embedding_result_Embedding", "containers::embedding_result::Embedding"],
    ["autoit_PacketsCallback", "mediapipe::autoit::PacketsCallback"],
    ["audio_task_running_mode_AudioTaskRunningMode", "audio_task_running_mode::AudioTaskRunningMode"],
]);
...
exports.PTR = new Set([
    ...
    "uchar*",
    "HWND",
    "mediapipe::autoit::PacketCallback",
    "mediapipe::autoit::PacketsCallback",
]);

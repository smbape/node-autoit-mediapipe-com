...
$OpenCVInteropServices = _OpenCV_FindFile -Path "dotnet\OpenCV.InteropServices.dll" -SearchPaths @(
    "."
    "autoit-opencv-com"
    "autoit-opencv-com\dotnet"
)

$MediapipeComInterop = _Mediapipe_FindFile -Path "dotnet\MediapipeComInterop.cs" -SearchPaths @(
    "."
    "autoit-mediapipe-com"
)

$MediapipeInteropServices = _Mediapipe_FindFile -Path "dotnet\Mediapipe.InteropServices.dll" -SearchPaths @(
    "."
    "autoit-mediapipe-com"
    "autoit-mediapipe-com\generated"
)

$Parameters = New-Object System.Collections.Generic.List[string]

$Parameters.Add("/link:$MediapipeInteropServices")
...
$Parameters.Add($MediapipeComInterop)

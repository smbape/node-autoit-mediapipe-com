...
Func _Mediapipe_Open_And_Register($s_mediapipe_wolrd_dll = Default, $s_autoit_mediapipe_com_dll = Default, $bUser = Default)
	If Not _Mediapipe_Open($s_mediapipe_wolrd_dll, $s_autoit_mediapipe_com_dll) Then Return False
...
Func _Mediapipe_Install($s_mediapipe_wolrd_dll = Default, $s_autoit_mediapipe_com_dll = Default, $bUser = Default, $bOpen = True, $bClose = True, $bInstall = False, $bUninstall = False)
	If $s_mediapipe_wolrd_dll == Default Then $s_mediapipe_wolrd_dll = "opencv_world460.dll"
...
Func _Mediapipe_Open($s_mediapipe_wolrd_dll = Default, $s_autoit_mediapipe_com_dll = Default)
	Return _Mediapipe_Install($s_mediapipe_wolrd_dll, $s_autoit_mediapipe_com_dll)
...
Func _Mediapipe_DebugMsg($msg)
	...
	EndIf
	If BitAND($_mediapipe_debug, 2) Then

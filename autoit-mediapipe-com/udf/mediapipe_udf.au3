...
Func _Mediapipe_Install($s_mediapipe_world_dll = Default, $s_autoit_mediapipe_com_dll = Default, $bUser = Default, $bOpen = True, $bClose = True, $bInstall = False, $bUninstall = False)
	If $s_mediapipe_world_dll == Default Then $s_mediapipe_world_dll = "opencv_world4130.dll"
	If $s_autoit_mediapipe_com_dll == Default Then $s_autoit_mediapipe_com_dll = "autoit_mediapipe_com-0.10.35-4130.dll"
	...
	If $bOpen And EnvGet("MEDIAPIPE_BUILD_TYPE") == "Debug" Then
		$h_mediapipe_ffmpeg_dll = _Mediapipe_LoadDLL(StringReplace($s_mediapipe_world_dll, "opencv_world4130d.dll", "opencv_videoio_ffmpeg4130_64.dll"))

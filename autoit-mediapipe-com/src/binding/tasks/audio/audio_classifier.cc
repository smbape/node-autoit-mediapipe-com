...
namespace {
	...
	using AudioClassifierResult = ClassificationResult;
			...
			namespace audio {
				namespace audio_classifier {
					...
					std::shared_ptr<AudioClassifierGraphOptions> AudioClassifierOptions::to_pb2() {
						...
						pb2_obj->mutable_classifier_options()->set_score_threshold(score_threshold);
						...
						pb2_obj->mutable_classifier_options()->set_display_names_locale(display_names_locale);
						pb2_obj->mutable_classifier_options()->set_max_results(max_results);

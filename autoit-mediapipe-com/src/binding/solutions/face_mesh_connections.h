...
namespace mediapipe::autoit::solutions::face_mesh_connections {
	static const std::vector<std::tuple<int, int>> FACEMESH_LIPS = { {61, 146}, {146, 91}, {91, 181}, {181, 84}, {84, 17},
	...
	static const std::vector<std::tuple<int, int>> FACEMESH_LEFT_EYE = { {263, 249}, {249, 390}, {390, 373}, {373, 374},
								   {374, 380}, {380, 381}, {381, 382}, {382, 362},
								   {263, 466}, {466, 388}, {388, 387}, {387, 386},
								   {386, 385}, {385, 384}, {384, 398}, {398, 362} };

	static const std::vector<std::tuple<int, int>> FACEMESH_LEFT_IRIS = { {474, 475}, {475, 476}, {476, 477},
									 {477, 474} };

	static const std::vector<std::tuple<int, int>> FACEMESH_LEFT_EYEBROW = { {276, 283}, {283, 282}, {282, 295},
									   {295, 285}, {300, 293}, {293, 334},
									   {334, 296}, {296, 336} };

	static const std::vector<std::tuple<int, int>> FACEMESH_RIGHT_EYE = { {33, 7}, {7, 163}, {163, 144}, {144, 145},
									{145, 153}, {153, 154}, {154, 155}, {155, 133},
									{33, 246}, {246, 161}, {161, 160}, {160, 159},
									{159, 158}, {158, 157}, {157, 173}, {173, 133} };

	static const std::vector<std::tuple<int, int>> FACEMESH_RIGHT_EYEBROW = { {46, 53}, {53, 52}, {52, 65}, {65, 55},
										{70, 63}, {63, 105}, {105, 66}, {66, 107} };

	static const std::vector<std::tuple<int, int>> FACEMESH_RIGHT_IRIS = { {469, 470}, {470, 471}, {471, 472},
									 {472, 469} };

	static const std::vector<std::tuple<int, int>> FACEMESH_FACE_OVAL = { {10, 338}, {338, 297}, {297, 332}, {332, 284},
	...
	static const std::vector<std::tuple<int, int>> FACEMESH_TESSELATION = {
